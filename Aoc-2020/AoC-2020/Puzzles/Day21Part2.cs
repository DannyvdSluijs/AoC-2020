...
{
    public static class Day21Part2
    {
...
".Trim().Split("\n");
            ...
            var answer = results.OrderBy(x => x.Key)
                .Select(x => x.Value.First());

            Console.WriteLine($"The answer is {String.Join(",", answer)}"); // vrzkz,zjsh,hphcb,mbdksj,vzzxl,ctmzsr,rkzqs,zmhnj
        }
    }
}