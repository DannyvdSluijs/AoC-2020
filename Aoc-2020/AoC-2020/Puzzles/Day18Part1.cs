...
{
    public static class Day18Part1
    {
...
";
            ...
            Console.WriteLine($"The answer is {answer}"); // 6923486965641
        }
            ...
            for (var i = 0; i < input.Length; i++)
            {
                ...
                switch (current)
                {
                    ...
                    case '*':
                        ...
                        break;
                    case '(':
                        var sub = trimUntilMatchingClosingBracket(input.Substring(i));
                        value = Resolve(sub);
                        if (operation == "+")
                        {
                        ...
                        break;
                    default:
                        value = Int64.Parse(current.ToString());
                        if (operation == "+")
                        {
                            stack.Push(stack.Pop() + value);
                            break;
